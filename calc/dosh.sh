...
# first letter
grep "= 1" $f.p1 | sort -nr -t' ' -k 3 > $f.z1

# second letter
grep "= 2" $f.p1 | sort -nr -t' ' -k 3 > $f.z2

# thirth letter
grep "= 3" $f.p1 | sort -nr -t' ' -k 3 > $f.z3

# fourth letter
grep "= 4" $f.p1 | sort -nr -t' ' -k 3 > $f.z4

# last letter
grep "= 5" $f.p1 | sort -nr -t' ' -k 3 > $f.z5

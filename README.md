...
Inspired in [Sweep]Alike [Many Splited]( https://github.com/diimdeep/awesome-split-keyboards) or reduced splited [Ergogen](https://github.com/topics/ergogen) and [Cheapino](https://github.com/tompi/cheapino/blob/master/readme.md)
